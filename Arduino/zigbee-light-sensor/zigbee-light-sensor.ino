...
static void illuminance_sensor_value_update(void *arg) {
  for (;;) {
    ...
    zbIlluminanceSensor.setIlluminance(lux);  // use raw illuminance here!
...
void setup() {
  ...
  zbIlluminanceSensor.setManufacturerAndModel("TeddyBerend", "AZLM 1");
  ...
  zbIlluminanceSensor.setMinMaxValue(0, 5000);
